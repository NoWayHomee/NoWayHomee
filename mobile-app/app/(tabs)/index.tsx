...
const styles = StyleSheet.create({
  ...
  heroText: { ...Typography.h1, color: 'white', fontFamily: Platform.OS === 'ios' ? 'Georgia' : 'serif', paddingHorizontal: Spacing.lg, marginVertical: Spacing.lg, textAlign: 'center', transform: [{ translateY: -30 }] },
  searchBox: { backgroundColor: 'white', marginHorizontal: Spacing.lg, borderRadius: BorderRadius.lg, padding: Spacing.md, ...Shadows.lg, marginTop: Spacing.sm, marginBottom: -100, transform: [{ translateY: -40 }] },
  ...
  categories: { padding: Spacing.md, gap: Spacing.sm, marginTop: 20 },
